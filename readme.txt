...
All code is copyrighted under the MIT License (MIT), which can be found in mit.txt.

The databases are made available under the Open Database License (ODbL), which can be found in odbl-1.0.txt.
